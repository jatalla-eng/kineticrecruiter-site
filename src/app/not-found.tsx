...
export const metadata: Metadata = {
  title: 'Page Not Found | KineticRecruiter',
...
export default function NotFound() {
  return (
    <div className="min-h-[60vh] flex flex-col items-center justify-center px-4 py-24 text-center">
      <p className="text-6xl font-bold mb-4" style={{ color: '#0d8488' }}>
        404
      </p>
      <h1 className="text-3xl font-semibold mb-4" style={{ color: '#1a2332' }}>
        Page Not Found
      </h1>
      ...
      <div className="flex flex-col sm:flex-row gap-4 justify-center">
        ...
        <Link
          href="/"
          className="px-6 py-3 rounded-lg font-medium border border-gray-200 hover:border-gray-300 transition-colors"
          style={{ color: '#1a2332' }}
        >
          Go Home
        </Link>
      ...
      <div className="mt-12 flex flex-col sm:flex-row gap-4 text-sm">
        ...
        <Link
          ...
          className="hover:text-[#0d8488] transition-colors"
          style={{ color: '#1a2332' }}
        >
